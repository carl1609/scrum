# Generated by Django 4.2 on 2024-10-22 21:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('velocidad', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prioridad', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ...
                ('esfuerzo_estimado', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_actualizacion', models.DateTimeField(auto_now=True)),
                ('bloqueadores', models.TextField(blank=True, null=True)),
                ('dependencias', models.ManyToManyField(blank=True, to='app.tarea')),
                ('responsable', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('sprint_asignado', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.sprint')),
            ],
        ),
        migrations.AddField(
            model_name='sprint',
            name='backlog_sprint',
            field=models.ManyToManyField(to='app.tarea'),
        ),
        migrations.AddField(
            model_name='sprint',
            name='equipo_desarrollo',
            field=models.ManyToManyField(related_name='equipo_desarrollo', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='sprint',
            name='scrum_master',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='scrum_master', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='Epica',
            fields=[
                ...
                ('criterios_aceptacion', models.TextField(blank=True, null=True)),
                ('estado', models.CharField(choices=[('POR_HACER', 'Por Hacer'), ('EN_PROGRESO', 'En Progreso'), ('COMPLETADA', 'Completada')], default='POR_HACER', max_length=20)),
                ('esfuerzo_estimado_total', models.IntegerField(validators=[django.core.validators.MinValueValidator(0)])),
                ('fecha_inicio', models.DateField()),
                ('fecha_fin', models.DateField()),
                ('progreso', models.FloatField(validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(1)])),
                ('dependencias', models.ManyToManyField(blank=True, to='app.epica')),
                ('responsable', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('tareas_asociadas', models.ManyToManyField(to='app.tarea')),
            ],
        ),
